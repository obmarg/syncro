...
private:
	System::Windows::Forms::CheckBox ^  chkReadable;
private:
	System::Windows::Forms::CheckBox ^  chkWriteable;
private:
...
#pragma endregion
private:
	System::Void OkClicked( System::Object ^  sender, System::EventArgs ^  e )
	{
		m_ok = true;
		Close();
	}
private:
	System::Void CancelClicked( System::Object ^  sender, System::EventArgs ^  e )
	{
		m_ok = false;
		Close();
	}
